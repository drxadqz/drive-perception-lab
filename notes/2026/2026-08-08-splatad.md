...
<p align="center"><picture><source media="(prefers-color-scheme: dark)" srcset="../../assets/notes/2026-08-08-splatad/formulas/eq-04-total-loss-dark.png"><img src="../../assets/notes/2026-08-08-splatad/formulas/eq-04-total-loss-light.png" alt="公式：相机重建、LiDAR 距离视线强度丢束与 MCMC 正则的加权总损失" width="673" height="85"></picture></p>

> **公式来源：** Hess et al., CVPR 2025, Eq. (13)，§3.4，PDF p. 5；本图按原符号主动换行。[官方 PDF](https://openaccess.thecvf.com/content/CVPR2025/papers/Hess_SplatAD_Real-Time_Lidar_and_Camera_Rendering_with_3D_Gaussian_Splatting_CVPR_2025_paper.pdf) · [可复制 TeX](../../assets/notes/2026-08-08-splatad/formulas/source.tex#L32-L42)。
